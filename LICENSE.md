...
- Build one for yourself, friends, family, classroom, or hackerspace
- Modify the design and share your changes
- Use it at home, school, lab, or office
- Repair, remix, and learn from it

## You CANNOT (without written permission from Autonomous AI)

- Sell the chair, kits, parts, or assembled units
- Use it in a paid product or service
- Manufacture for resale
- Use the design, files, or brand for commercial gain

## You MUST

- Give credit: *"Based on Autonomous ErgoChair Ultra 2 by Autonomous AI"*
- Share your modifications under the same license
- Link back to this repo

## Want to Use It Commercially?

Open an Issue titled `[COMMERCIAL] your question` — we are open to talking.
